/* ===================== chrome.js — okablowanie DOM (UI) ===================== */
// Toolbar, menu rozwijane, menu układów, panele/raile/pozycja minimapy, wygląd (glass, presety, motyw,
// codemap_settings), wygląd węzłów, filtry/metryka, view-controls, wyszukiwarka, DnD, wklejanie, klawiatura,
// brand, zegar, sekcje zwijane, modale, PWA, ustawienia. Dopisuje się do CM.App (A).
(function(){
  const A=CM.App;
